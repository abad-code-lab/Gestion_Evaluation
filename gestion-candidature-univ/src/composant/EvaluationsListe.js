...
//     let errorMessage;
//     try {
//       // Tente seulement de parser en JSON
//       const errorData = await response.json();
//       // Si c’est un objet avec message, extrait éventuellement
//       errorMessage = errorData.message || JSON.stringify(errorData);
//     } catch {
//       // En cas d’échec de parsing JSON, récupère le texte brut
//       errorMessage = await response.text();
//     }
//     throw new Error(`Erreur ${response.status} : ${errorMessage}`);
//   }
...
//   console.log("---------- Démarrage handleCreate ----------");

//   // Tente de récupérer l'inscription sélectionnée dans le localStorage
//   const inscriptionFromStorage = localStorage.getItem('inscription');
//   console.log("Valeur brute de localStorage.getItem('inscription'):", inscriptionFromStorage);

//   let inscriptionId = ''; // Variable pour stocker l'ID de l'inscription

//   if (inscriptionFromStorage) {
//     try {
//       const parsed = JSON.parse(inscriptionFromStorage);
//       console.log("Objet parsé du localStorage:", parsed);

//       // Vérifie si 'parsed' est un objet et s'il a une propriété 'id'
//       if (typeof parsed === 'object' && parsed !== null && parsed.hasOwnProperty('id')) {
//         inscriptionId = parsed.id;
//         console.log("ID d'inscription récupéré avec succès:", inscriptionId);
//       } else {
//         console.warn("L'objet parsé n'a pas de propriété 'id' ou n'est pas un objet valide.");
//         inscriptionId = ''; // S'assurer qu'il est vide si l'ID n'est pas trouvé
//       }

//     } catch (error) {
//       // Le parsing JSON a échoué (ex: la chaîne n'est pas un JSON valide)
//       console.error("Erreur lors du parsing JSON de l'inscription depuis le localStorage:", error);
//       inscriptionId = ''; // En cas d'erreur, l'ID est vide
//     }
//   } else {
//     // Aucune donnée pour 'inscription' dans le localStorage
//     console.log("Aucune clé 'inscription' trouvée dans le localStorage.");
//     inscriptionId = ''; // L'ID reste vide
//   }

//   // Initialise le formulaire avec l'ID d'inscription obtenu
//   setForm({
//     noteControle: '',
//     noteExamen: '',
//     inscriptionId: inscriptionId, // Utilise l'ID potentiellement récupéré
//   });
//   setInscriptionSearch('');
//   setShowModal(true);

//   console.log("---------- Fin handleCreate ----------");
// };
...
//   // Validation des notes (déjà en place, c'est très bien)
//   if (isNaN(noteControleNum) || noteControleNum < 0 || noteControleNum > 20) {
//     alert("La note de contrôle doit être un nombre entre 0 et 20.");
//     return;
//   }
...
//   try {
//     const evaluation = {
//       noteControle: noteControleNum, // nombre décimal
//       noteExamen: noteExamenNum,      // nombre décimal
//       inscriptionId: inscriptionIdNum,
//     };
...
//     setShowModal(false);
//   } catch (error) {
//     // MODIFICATION ICI : Affiche le message d'erreur détaillé de l'API
//     alert("Une erreur est survenue lors de la sauvegarde : " + error.message);
//     console.error("Détail de l'erreur :", error); // Ajoute ce log pour voir l'objet erreur complet
//   } finally {
//     setIsSubmitting(false);
//   }
// };
...
//   return (
//     <>
//       {/* Style global pour supprimer les flèches sur inputs type=number */}
//       <style>{`
...
// // Styles similaires à ton code initial (non modifiés ici pour la clarté)...
// const createBtnStyle = {
//   background: '#2563eb',
//   color: 'white',
//   border: 'none',
...
// // const API_EVALUATIONS_URL = '/api/evaluations';
// const API_EVALUATIONS_URL = 'http://localhost:8080/api/v1/evaluations';
...
//   // États pour inscriptions locales
//   const [inscriptions, setInscriptions] = useState([]);
//   const [inscriptionSearch, setInscriptionSearch] = useState('');
//   const [filteredInscriptions, setFilteredInscriptions] = useState([]);
...
//   async function createEvaluation(evaluation) {
//     await fetch(API_EVALUATIONS_URL, {
//       method: 'POST',
//       headers: { 'Content-Type': 'application/json' },
//       body: JSON.stringify(evaluation),
//     });
...
//   async function updateEvaluation(id, evaluation) {
//     await fetch(`${API_EVALUATIONS_URL}/${id}`, {
//       method: 'PUT',
//       headers: { 'Content-Type': 'application/json' },
//       body: JSON.stringify(evaluation),
//     });
...
//   async function deleteEvaluation(id) {
//     await fetch(`${API_EVALUATIONS_URL}/${id}`, { method: 'DELETE' });
//     fetchEvaluations();
//     setSelectedIndex(null);
//   }
...
//   // Charger inscription depuis localStorage
//   const inscriptionFromStorage = localStorage.getItem('inscription');
//   let inscriptionId = '';
//   if (inscriptionFromStorage) {
//     try {
...
//     noteControle: '',
//     noteExamen: '',
//     inscriptionId: inscriptionId,  // Préréglé avec l'inscription sélectionnée
//   });
//   setInscriptionSearch('');
//   setShowModal(true);
// };
...
//     setModalMode('edit');
//     setForm({
//       noteControle: ev.noteControle,
//       noteExamen: ev.noteExamen,
//       inscriptionId: ev.inscription.id,
//     });
//     setShowModal(true);
//   };
...
//   const handleModalSubmit = async (e) => {
//     e.preventDefault();
//     console.log("handleModalSubmit déclenché", form);
...
//     try {
//       const evaluation = {
//         noteControle: parseFloat(form.noteControle),
//         noteExamen: parseFloat(form.noteExamen),
